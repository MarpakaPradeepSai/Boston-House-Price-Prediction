...
if st.button('Predict 🔍'):
    if input_data is not None:
        ...
        st.markdown(f"""
            <div style="background-color: green; padding: 5px; text-align: center; border-radius: 10px; width: 250px; margin: auto;">
                <h4 style="color: white; margin: 0;"><strong>Predicted Median Value</strong></h4>
                <p style="font-size: 16px; color: white; margin: 0;">${median_value:.2f}</p>
            </div>
        """, unsafe_allow_html=True)
    else:
